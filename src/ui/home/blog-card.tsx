        ...
        <Link href={link} className="block">
            <div className="bg-white shadow-md rounded-2xl hover:outline outline-cyan-700 outline-offset-2 ">
                <div className="relative w-full h-60">
                    <Image loading="lazy" src={imageUrl} alt={altText} className=" object-cover rounded-t-2xl" fill />
                </div>
...
export const BlogCardSkele = () => {
    return (
        <div className="bg-white shadow-md rounded-2xl hover:outline outline-cyan-700 outline-offset-2 animate-pulse">
            <div className="relative w-full h-60 bg-gray-200 rounded-t-2xl"></div>
            <div className="p-4">
